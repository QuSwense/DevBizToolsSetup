...
{
	/// <summary>
	/// Unique identifier for this RolePermissions record.
	/// </summary>
	...
	#region Associations
	/// <summary>
	/// FK_RolePermissions_ResourcePermissions_ResourcePermissionId
	/// </summary>
	...
	/// </summary>
	[Association(CanBeNull = false, ThisKey = nameof(RoleId), OtherKey = nameof(PermissionsManagement.Role.Id))]
