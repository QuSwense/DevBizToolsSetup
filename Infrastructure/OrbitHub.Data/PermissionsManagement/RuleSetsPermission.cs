...
public partial class RuleSetsPermission
{
	/// <summary>
	/// Unique identifier for this RuleSetsPermissions record.
	/// </summary>
	...
	#region Associations
	/// <summary>
	/// FK_RuleSetsPermissions_ResourcePermissions_ResourcePermissionId
	/// </summary>
	...
	/// <summary>
	/// FK_RuleSetsPermissions_Roles_RoleId
	/// </summary>
