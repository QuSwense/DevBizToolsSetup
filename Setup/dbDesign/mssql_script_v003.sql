...
-- ==========================================
-- Create EntityChangeHistory Table (Universal Audit Trail for All Tables)
-- ==========================================
IF NOT EXISTS (
    SELECT * 
    FROM [sysobjects] 
    WHERE [name] = 'EntityChangeHistory' AND [xtype] = 'U'
)
BEGIN
...
-- ==========================================
-- Create SoapExecutionGroups Table (Group Definition Entity Only)
-- Cleaned of execution runtime states and redundant item counts
-- ==========================================
IF NOT EXISTS (
...
-- Allows sharing execution group definitions with specific users
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapExecutionGroupsPermissions' AND [xtype] = 'U'
)
BEGIN
...
-- Maps request files to a SoapExecutionGroup definition
-- ==========================================
IF NOT EXISTS (
...
-- ==========================================
-- Create SoapExecutionRuns Table (NEW: Runtime Execution State)
-- Tracks each independent execution run instance of an Execution Group
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapExecutionRuns' AND [xtype] = 'U'
)
BEGIN
...
-- ==========================================
-- Create SoapExecutionItemRuns Table (Renamed from SoapExecutionHistory)
-- Tracks the execution outcome of individual group items during an Execution Run
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapExecutionItemRuns' AND [xtype] = 'U'
)
BEGIN
...
-- ==========================================
-- Update SoapResponseFiles FK to reference SoapExecutionItemRuns
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapResponseFiles' AND [xtype] = 'U'
)
BEGIN
...
-- ==========================================
-- Create SoapResponseAttachments Table (EXTRACTED EMBEDDED FILES)
-- Holds base64 / binary attachments extracted from response envelopes
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapResponseAttachments' AND [xtype] = 'U'
)
BEGIN
...
-- ==========================================
-- Create SoapResponseFileHistory Table (RESPONSE DIFFERENTIAL VERSIONING)
-- ==========================================
IF NOT EXISTS (
    SELECT * FROM [sysobjects] WHERE [name] = 'SoapResponseFileHistory' AND [xtype] = 'U'
)
BEGIN
...
CREATE INDEX [IX_SoapExecutionHistory_RunId] ON [SoapExecutionHistory]([ExecutionRunId]);
CREATE INDEX [IX_SoapExecutionHistory_RequestFileId] ON [SoapExecutionHistory]([RequestFileId]);
CREATE INDEX [IX_SoapResponseFiles_ExecutionHistoryId] ON [SoapResponseFiles]([ExecutionHistoryId]);
