...
(function () {
    ...
    const STATE = {
        ...
        APP_PERFORMANCE_VIEW_KEY: 'devbiztools.dashboard.appPerformanceView',
        APP_PERFORMANCE_METRIC_KEY: 'devbiztools.dashboard.appPerformanceMetric',
        SERVICE_UTIL_VIEW_KEY: 'devbiztools.dashboard.serviceUtilView'
    };
    ...
    function restoreSavedViews() {
        const savedServiceUtil = localStorage.getItem(STATE.SERVICE_UTIL_VIEW_KEY) || 'list';
        setServiceUtilizationView(savedServiceUtil, false);

        const savedMetric = localStorage.getItem(STATE.APP_PERFORMANCE_METRIC_KEY) || 'calls';
        setAppPerformanceMetric(savedMetric, false);

        const savedView = localStorage.getItem(STATE.APP_PERFORMANCE_VIEW_KEY) || 'list';
    ...
    function setAppPerformanceView(view = 'list', persist = true) {
        ...
        if (persist) localStorage.setItem(STATE.APP_PERFORMANCE_VIEW_KEY, normalizedView);
    }
    ...
    function setAppPerformanceMetric(metric = 'calls', persist = true) {
        ...
        if (persist) localStorage.setItem(STATE.APP_PERFORMANCE_METRIC_KEY, normalizedMetric);
        buildAppPerformanceGraph();
    }
    ...
    function setServiceUtilizationView(view = 'list', persist = true) {
        ...
        if (persist) localStorage.setItem(STATE.SERVICE_UTIL_VIEW_KEY, normalizedView);
    }
