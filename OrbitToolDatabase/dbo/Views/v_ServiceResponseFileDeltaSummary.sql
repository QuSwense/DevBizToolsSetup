/*
    View: v_ServiceResponseFileDeltaSummary
    Description: Summary of delta chains per base response file.
*/
CREATE VIEW [dbo].[v_ServiceResponseFileDeltaSummary]
AS
WITH DeltaStats AS (
    SELECT 
        ...
        COUNT(DISTINCT [ServiceRequestFileId]) AS UniqueRequestFiles
...
SELECT 
    b.[Id] AS BaseResponseFileId,
    b.[Name] AS BaseResponseFileName,
    b.[FileFormat],
...
FROM [dbo].[ServiceResponseFiles] b
INNER JOIN [dbo].[ServiceRequestFiles] req ON b.[ServiceRequestFileId] = req.[Id]
