/*
    Stored Procedure: usp_InsertServiceTestCaseRuleSetLinks
    Description: Links a rule set to a test case.
*/
CREATE PROCEDURE [dbo].[usp_InsertServiceTestCaseRuleSetLinks]
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF EXISTS (
            SELECT 1 
            FROM [dbo].[ServiceTestCaseRuleSetLinks] WITH (UPDLOCK, HOLDLOCK)
