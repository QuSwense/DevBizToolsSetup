/*
    Stored Procedure: usp_InsertOrGetIndexingJsonFileElementSearch
...
*/
CREATE PROCEDURE [dbo].[usp_InsertOrGetIndexingJsonFileElementSearch]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [dbo].[IndexingJsonFileElementSearch] WITH (UPDLOCK, HOLDLOCK)
    ...
    BEGIN CATCH
        ...
        RAISERROR('Error inserting or getting JSON file element search entry: %s', @ErrorSeverity, @ErrorState, @ErrorMessage);
    END CATCH
END;
GO