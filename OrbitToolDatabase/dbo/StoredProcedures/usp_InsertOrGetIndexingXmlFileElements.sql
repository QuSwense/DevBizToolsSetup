/*
    Stored Procedure: usp_InsertOrGetIndexingXmlFileElements
...
*/
CREATE PROCEDURE [dbo].[usp_InsertOrGetIndexingXmlFileElements]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [dbo].[IndexingXmlFileElements] WITH (UPDLOCK, HOLDLOCK)
    ...
    BEGIN CATCH
        ...
        RAISERROR('Error inserting or getting XML file element: %s', @ErrorSeverity, @ErrorState, @ErrorMessage);
    END CATCH
END;
GO