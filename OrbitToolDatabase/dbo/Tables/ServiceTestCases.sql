CREATE TABLE [dbo].[ServiceTestCases] (
    ...
    CONSTRAINT CK_ServiceTestCases_OneParent
        CHECK (
    ...
    CONSTRAINT FK_ServiceTestCases_ServiceRequestFileHistories_ServiceRequestFileHistoryId
        FOREIGN KEY ([ServiceRequestFileHistoryId]) REFERENCES [dbo].[ServiceRequestFileHistories]([Id]),
