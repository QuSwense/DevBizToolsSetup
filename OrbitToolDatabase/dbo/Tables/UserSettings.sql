...
CREATE TABLE [dbo].[UserSettings] (
    ...
    [LastUpdatedAt] DATETIME2(3) NOT NULL CONSTRAINT DF_UserSettings_LastUpdatedAt DEFAULT GETDATE(),
    ...
    CONSTRAINT FK_UserSettings_Users_UserId FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users]([UserId])
);
GO
...
CREATE UNIQUE NONCLUSTERED INDEX IX_UserSettings_User_GlobalSetting
