...
CREATE TABLE [dbo].[ServiceAppPermissions] (
    ...
    [CreatedAt] DATETIME2(3) NOT NULL CONSTRAINT DF_ServiceAppPermissions_CreatedAt DEFAULT GETDATE(),
...
CREATE UNIQUE NONCLUSTERED INDEX IX_ServiceAppPermissions_App_User_Resource
    ON [dbo].[ServiceAppPermissions]([ServiceApplicationId] ASC, [UserId] ASC, [ResourcePermissionId] ASC)
    WHERE [UserId] IS NOT NULL
GO

CREATE UNIQUE NONCLUSTERED INDEX IX_ServiceAppPermissions_App_Role_Resource
    ON [dbo].[ServiceAppPermissions]([ServiceApplicationId] ASC, [RoleId] ASC, [ResourcePermissionId] ASC)
