...
CREATE TABLE [dbo].[ServiceRequestFilesPermissions] (
    ...
    [CreatedAt] DATETIME2(3) NOT NULL CONSTRAINT DF_ServiceRequestFilesPermissions_CreatedAt DEFAULT GETDATE(),
...
CREATE UNIQUE NONCLUSTERED INDEX IX_ServiceRequestFilesPermissions_File_User_Resource
    ON [dbo].[ServiceRequestFilesPermissions]([ServiceRequestFileId] ASC, [UserId] ASC, [ResourcePermissionId] ASC)
    WHERE [UserId] IS NOT NULL
GO

CREATE UNIQUE NONCLUSTERED INDEX IX_ServiceRequestFilesPermissions_File_Role_Resource
