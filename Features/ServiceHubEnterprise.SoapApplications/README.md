# ServiceHubEnterprise.SoapApplications
...
```
Features/ServiceHubEnterprise.SoapApplications/
│
...
│       └── soap-apps.css
│
├── ServiceHubEnterprise.SoapApplications.csproj
├── _Imports.razor
└── README.md
```
...
- **ServiceHubEnterprise.Grid** — shared data-grid component
- **ServiceHubEnterprise.Ui** — shared UI components (SectionCard, KpiTile, etc.)
