...
Steps:
- 0.1 New models in `Features/ServiceHubEnterprise.SoapApplications/Models/`:
...
- 6.2 Test Suite feature (`ServiceHubEnterprise.TestSuite`) integration with test cases.
...
## Relevant files
- `Features/ServiceHubEnterprise.SoapApplications/Models/` — new + extended models (SoapRequestFile).
- `Features/ServiceHubEnterprise.SoapApplications/Core/Enums/` — ExecutionStage.
- `Features/ServiceHubEnterprise.SoapApplications/Services/Execution/IExecutionEngine.cs`, `SimulatedSoapExecutionEngine.cs`.
- `Features/ServiceHubEnterprise.SoapApplications/Services/SoapExecutionStore.cs`, `SoapTestCaseStore.cs`.
- `Features/ServiceHubEnterprise.SoapApplications/DependencyInjection/ServiceCollectionExtensions.cs` — register new services.
- `Features/ServiceHubEnterprise.SoapApplications/Pages/Applications.razor(.cs)`, `RequestFiles.razor(.cs)`, `WsdlSync.razor(.cs)`, `ExecuteHistory.razor(.cs)`.
- `Features/ServiceHubEnterprise.SoapApplications/Components/ExecutionFileDetails.razor(.cs)`.
...
- `WebApp/ServiceHubEnterprise.Web/appsettings.json` — MockDb:ExecutionStageDelayMs.
- Tests: `tests/ServiceHubEnterprise.Tests/SoapApplications/`.

## Verification
- Per phase: `dotnet build WebApp/ServiceHubEnterprise.Web/ServiceHubEnterprise.Web.csproj`; `dotnet test tests/ServiceHubEnterprise.Tests/...`.
